...
{
    public class ProductsControllertemp : Controller
    {
        private IWebHostEnvironment Environment;
        private readonly ApplicationDbContext _context;
        private readonly UserManager<ApplicationUser> _userManager;

        public ProductsControllertemp(ApplicationDbContext context, IWebHostEnvironment environment, UserManager<ApplicationUser> userManager)
        {
            _context = context;
       ...
       /* [Authorize(Roles = "Admin")]*/
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,DateStart,DateEnd,Image,PriceStart,PriceEnd,PriceFinish")] Product @product, List<IFormFile> files)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,DateStart,DateEnd,Image,PriceStart,PriceEnd,PriceFinish")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
